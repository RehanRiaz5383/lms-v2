...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('notifications', function (Blueprint $table) {
            // Make notifiable_type nullable if it exists
            if (Schema::hasColumn('notifications', 'notifiable_type')) {
                $table->string('notifiable_type')->nullable()->change();
            }
            // Make notifiable_id nullable if it exists
    ...
    {
        Schema::table('notifications', function (Blueprint $table) {
            // Revert notifiable_type to not nullable if it exists
            if (Schema::hasColumn('notifications', 'notifiable_type')) {
                $table->string('notifiable_type')->nullable(false)->change();
            }
            // Revert notifiable_id to not nullable if it exists
            if (Schema::hasColumn('notifications', 'notifiable_id')) {
